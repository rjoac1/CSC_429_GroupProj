...
public class SQLInsertStatement extends SQLStatement
{
	 ...
	 */
	//------------------------------------------------------------
	public SQLInsertStatement(final Properties schema, 		// the name of the table to insert into
			final Properties insertValues)	// the values to insert
	{
		...
		final Enumeration theValuesColumns = insertValues.propertyNames();
		...
		while (theValuesColumns.hasMoreElements() == true)
		{
			...
			final String theColumnName = (String)theValuesColumns.nextElement();
			// System.out.println("The column name is " + theColumnName);
			final String theColumnValue = insertEscapes(insertValues.getProperty(theColumnName));
			...
			final String insertType = schema.getProperty(theColumnName);
			//		System.out.println("InsertType = " + insertType);
			//System.out.println("Schema is : " + schema);

            System.err.println(theColumnName);
