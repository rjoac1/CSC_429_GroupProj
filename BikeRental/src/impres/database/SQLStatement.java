...
public abstract class SQLStatement
{
	...
	public String theSQLStatement;		// contains the resulting SQL statement
	...
	protected String insertEscapes(String inString)
	{
		...
		String outString = "";
		final int inStringLen = inString.length();
		...
		{
			final String prefix = inString.substring(0, indexOfEscapeChar);
			outString += prefix;
