...
public class SQLDeleteStatement extends SQLStatement
{
	 ...
	 */
	//------------------------------------------------------------
	public SQLDeleteStatement(final Properties schema, 		// the table schema
			final Properties whereValues	// the values to delete
			)
	{
		...
		if (whereValues != null)
		{
			final Enumeration theWhereColumns = whereValues.propertyNames();
			while (theWhereColumns.hasMoreElements() == true)
			{
				...
				final String theColumnName = (String)theWhereColumns.nextElement();
				final String theColumnValue = insertEscapes(whereValues.getProperty(theColumnName));
				...
				else
				{
					...
					final String whereTypeValue = schema.getProperty(theColumnName);
