...
public class EventLog
{
	...
	protected EventLog ()
	{
		...
		if(logFile.length() > MAX_SIZE)
		{
			...
			final File backupLog = new File(Backup);
	 ...
	 */
	//----------------------------------------------------------
	public void setSeverityFilter(final String level)
	{
	...
	public void addEvent(final Event event)
	{
		...
		if (event.getSeverity() >= Event.getSeverityMapping(reportingLevel))
		{
			...
			if (allowWrites)
			{
				...
				try
				{
					final FileOutputStream filestream = new FileOutputStream(LogFile, true);
					final OutputStreamWriter outstream = new OutputStreamWriter(filestream);
	 ...
	 */
	//---------------------------------------------------------------
	public static String replaceParameters(final String source, final String paramList, final boolean
			displaySubErrors)
	{
	 ...
	 */
	//---------------------------------------------------------------
	public static String replaceParameters(final String source, final String paramList)
	{
	 ...
	 */
	//-------------------------------------------------------------
	public static String replaceParameters(final String source, final String paramList, final boolean displaySubErrors,
			final boolean checkFileLength)
	{
		String[] params;
		int numOfParams = 0;
		...
		while (!done)
		{
			...
			final int posOfPlaceHolder = source.indexOf(OPEN_PLACEHOLDER, currentStringPosition);
			...
			else
			{
				...
				final int posOfClosePlaceHolder = source.indexOf(CLOSE_PLACEHOLDER, posOfPlaceHolder);
				...
				else
				{
					...
					final String paramIndexStr = source.substring(posOfPlaceHolder+1, posOfClosePlaceHolder);
					int paramIndex = 0;
