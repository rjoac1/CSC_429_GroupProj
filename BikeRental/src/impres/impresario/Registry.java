...
public abstract class Registry
{
	...
	protected Hashtable<String, Object> mySubscribers;
	protected String myClassName;


	// Class constructor
	//----------------------------------------------------------
	public Registry(final String classname) 	// the name of the class that contains this Registry, debug only
	{
		myClassName = classname;	// remember our classname for debug messages

		// create an object to hold our subscriber list
		mySubscribers = new Hashtable<String, Object>();
	 ...
	 */
	//----------------------------------------------------------
	public void subscribe(final String key, final Object subscriber)
	{
		...
		if(mySubscribers.containsKey(key) == true)
		{
			...
			final Object tempObj = mySubscribers.get(key);
	 ...
	 */
	//----------------------------------------------------------
	public void unSubscribe(final String key, final Object subscriber)
	{
		// debug only, doesn't need translation
